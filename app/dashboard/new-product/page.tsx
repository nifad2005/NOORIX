...
export default function Page() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try{
      setLoading(true)
      setStatus({message:"Adding New Product...🔃",type:"form"})
  ...
  return (
    <div className="max-w-xl mx-auto mt-16 bg-white rounded-lg shadow p-8">
      <h1 className="text-2xl font-bold mb-6 text-blue-700">Add New Product</h1>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        >
          {loading? <div className="">Loading...</div>:<div>Add Product</div>}
        </button>
      </form>
    </div>
  );
